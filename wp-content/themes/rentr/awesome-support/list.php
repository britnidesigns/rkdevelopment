...
if ( $wpas_tickets->have_posts() ):
	...
	<div class="wpas wpas-ticket-list">
        ...
        <?php wpas_make_button( __( '<i class="fas fa-wrench"></i>New Request', 'awesome-support' ), array( 'type' => 'link', 'link' => wpas_get_submission_page_url(), 'class' => 'btn new' ) ); ?>
...
<?php else:
    ...
    echo '<p class="empty-list">You haven\'t requested any maintenance at your property yet</p><a href="'. wpas_get_submission_page_url() .'" class="btn">New Maintenance Request</a>';
endif; ?>
