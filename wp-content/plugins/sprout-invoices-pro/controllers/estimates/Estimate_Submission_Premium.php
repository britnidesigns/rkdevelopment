...
class SI_Estimates_Submission_Premium extends SI_Estimate_Submissions {
			...
			'estimate_submissions' => array(
				...
				'settings' => array(
					'default_submission_page' => array(
						...
						'option' => array(
							'type' => 'bypass',
							'output' => sprintf( '<code>[%1$s]%2$s[/%1$s]</code>', self::SUBMISSION_SHORTCODE,  __( 'Thank You!', 'sprout-invoices' ) ),
	...
	public static function submission_settings_description() {
		printf( __( 'Estimate submissions is the start of the <a href="%s">Sprout Invoices workflow</a>.', 'sprout-invoices' ), self::PLUGIN_URL );
	}
		...
		?>
			<div class="sa_addon">
				<div class="add_on_img_wrap">
					...
					<a class="purchase_button button button-primary button-large" href="<?php sa_link( 'https://sproutapps.co/marketplace/advanced-form-integration-gravity-ninja-forms/' ) ?>"><?php _e( '$0', 'sprout-invoices' ) ?></a>
				</div>
